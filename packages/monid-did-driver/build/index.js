...
var did_resolver_2 = require("@monid/did-resolver");
...
// did resolve
router.get('/1.0/identifiers/:did', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var did, resolver, didDocument;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                resolver = new did_resolver_1.Resolver(did_resolver_2.getResolver());
